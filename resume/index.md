...
* **国家重点用能单位能耗在线监测项目（2016.3-至今）**：
    ...
    * 项目描述: 该[项目](http://www.ccgp.gov.cn/cggg/zygg/zbgg/201408/t20140811_4440864.htm)是一套基于SOA的国家级大型分布式系统。该系统通过数据接入传输平台，将数据从企业现场采集到国家平台及各个省平台，云平台通过数据清洗处理后进行建模统计，统计后的数据提供给应用层的政府服务平台、企业服务平台以及公众平台。为了保证省平台和国家平台数据的一致性，在要求企业端设备同时向国家和省平台发送数据的前提下，通过省、国家数据同步服务器确保省平台和国家平台数据的一致性。该项目率先在北京、河南、陕西三个省市开展了试点工作，涉及电力、钢铁、石油石化三个重点行业的共184家试点企业已成功完成对接，验证了系统的可行性。 目前，在试点项目基础上，正在进行二期项目的扩容，预计建成后将覆盖全国31个省市约1.6万家重点用能单位，监测能耗量将占全社会能耗总量的60%。凭借先进的能源大数据技术，为政府部门掌握能源消费和节能形势、开展宏观调控、加强节能管理、应对国际气候谈判提供决策参考，也为用能单位提高能效水平发挥支撑作用。
