...
### 中控集团浙江中易和节能技术有限公司 （2016.3-2016.4）

在公司担任开发项目经理。 清理并偿还遗留系统的技术债务，持续对项目进行重构与改进，确保项目成功[验收](http://www.chinanecc.cn/website/News!view.shtml?id=181848)；负责从事核心部分代码的编写，核心模块的设计开发、评审，突破项目中的关键问题和技术难题，做好技术知识积累；参与产品的新需求分析与评审、系统架构设计与改进；负责项目管理，包括制定项目计划、控制项目进度、评估项目风险；协调工程、产品、测试、开发之间的关系；指导和培训工程师，对组员进行Code Review、监督测试质量，了解互联网的技术发展、评估外部技术与解决方案，提升团队的技术分析，设计和编码能力；参与公司的售后支持，包括项目部署实施、实际维护，对客户进行操作培训等；主持项目组的日常管理工作。所在项目组被评为“先进团队”。

* **国家重点用能单位能耗在线监测项目（2016.3-至今）**：
	* 责任描述: 负责该项目架构的重构与改进、项目管理、核心代码编写、项目运维、保障[验收](http://www.chinanecc.cn/website/News!view.shtml?id=181848)
    * 项目描述: 该[项目](http://www.ccgp.gov.cn/cggg/zygg/zbgg/201408/t20140811_4440864.htm)是一套基于SOA的国家级大型分布式系统。该系统通过数据接入传输平台，将数据从企业现场采集到国家平台及各个省平台，云平台通过数据清洗处理后进行建模统计，统计后的数据提供给应用层的政府服务平台、企业服务平台以及公众平台。为了保证省平台和国家平台数据的一致性，在要求企业端设备同时向国家和省平台发送数据的前提下，通过省、国家数据同步服务器确保省平台和国家平台数据的一致性。该项目率先在北京、河南、陕西三个省市开展了试点工作，涉及电力、钢铁、石油石化三个重点行业的共184家试点企业已成功完成对接，验证了技术的可行性。 目前，在试点项目基础上，正在进行二期项目的扩容，预计建成后将覆盖全国31个省市约1.6万家重点用能单位，监测能耗量将占全社会总量的60%。凭借先进的能源大数据技术，为政府部门掌握能源消费和节能形势、开展宏观调控、加强节能管理、应对国际气候谈判提供决策参考，也为用能单位提高能效水平发挥支撑作用。
...
* **浙江省智慧能源监测项目（2016.7-至今）**：
    ...
    * 项目描述: [项目](http://www.excenergy.com/index.php?colm=2&cata=6&content=415)该项目开发建设了智慧能源监测云平台（包括政府、公众和企业三个服务平台），实现了浙江省重点用能单位能源消费月报及万吨千家企业能源消费在线监测。 项目的成功实施，加快推进了浙江省能源监测的智慧化，提升了政府能源综合管理水平。该项目是全国首个建成的省级智慧能源在线监测系统。
    * 相关技术：Spring、SpringMVC、MyBatis、MySQL、Memcached、Maven、Thymeleaf、Bootstrap、jQuery、HTML5、JavaScript、CSS3、ECharts、CentOS
* **智慧能源产品（2016.9-至今）**：
	* 责任描述: 参与该项目架构的重构与改进、核心代码编写
    * 项目描述: 本项目依托国家重点用能单位能耗在线监测项目、浙江省智慧能源监测项目的技术和业务积累，打造一个功能丰富、可扩展、实施快速的智慧能源产品，实现智慧能源系列产品的统一升级和维护。
    * 相关技术：Spring、SpringBoot、SpringMVC、MyBatis、MySQL、DB2、Memcached、Maven、Thymeleaf、Bootstrap、jQuery、HTML5、JavaScript、CSS3、ECharts、CentOS、SUSE
