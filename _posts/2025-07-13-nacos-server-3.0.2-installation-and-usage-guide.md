...
|   :  :  | |                      '   ,'\   .--.--.    Port: 8080
:   |   \ | :  ,--.--.     ,---.  /   /   | /  /    '   Pid: 22260
|   : '  '; | /       \   /     \.   ; ,. :|  :  /`./   Console: http://192.168.186.124:8080/index.html
'   ' ;.    ;.--.  .-. | /    / ''   | |: :|  :  ;_
|   | | \   | \__\/: . ..    ' / '   | .; : \  \    `.      https://nacos.io
'   : |  ; .' ," .--.; |'   ; :__|   :    |  `----.   \
|   | '`--'  /  /  ,.  |'   | '.'|\   \  /  /  /`--'  /
...
2025-07-13 22:28:15,329 INFO Tomcat initialized with port 8080 (http)
...
2025-07-13 22:28:16,144 INFO Tomcat started on port 8080 (http) with context path '/'
...
浏览器打开`http://localhost:8080`，进入Nacos的Web界面。
...
Spring Cloud Alibaba目前最新版本是2023.0.3.3，最高只能支持到Spring Boot 3.3.13，以及JDK 17。
